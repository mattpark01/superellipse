...
exports.getSVGPathFromPathParams = exports.getPathParamsForCorner = void 0;
...
exports.getSVGPathFromPathParams = getSVGPathFromPathParams;
...
function rounded(strings, ...values) {
    return strings.reduce((acc, str, i) => {
        ...
        const roundedValue = typeof value === "number" ? preciseRound(value, 4) : value;
        return acc + str + (roundedValue !== null && roundedValue !== void 0 ? roundedValue : "");
    }, "");
}
